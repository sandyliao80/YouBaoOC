...
- (void)viewDidLoad {
    ...
    [leftBtn setImage:[UIImage imageNamed:@"en_left"] forState:UIControlStateNormal];
    [leftBtn setImage:[UIImage imageNamed:@"en_left"] forState:UIControlStateHighlighted];
